...
def execute(str_a, str_b):
    ...
    model = lda_model(data.comment, sw_in="tf-idf", min_in=1, max_in=1, num_of_topics=1, ntop_w=5)
...
# Modifying stoplist
stoplist = stopwords.words('english') + ['www', 'http', 'https', 'com', 'html', 'index'] + ["trump", "politics"]
